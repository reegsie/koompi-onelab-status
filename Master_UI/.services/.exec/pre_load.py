...
while True:
    ...
    for i in pc_ip:
        ...
        # This will send a request to each machine in a loop
         os.system("ping -c 1 192.168.1.{} -q -4  -W .001 && echo 'True' > /home/alarm/Documents/projects/Koompi_Stuff/koompi-onelab-status/Master_UI/.services/ip-ping/ping_{}.txt || echo 'False' > /home/alarm/Documents/projects/Koompi_Stuff/koompi-onelab-status/Master_UI/.services/ip-ping/ping_{}.txt".format(i, i, i))
